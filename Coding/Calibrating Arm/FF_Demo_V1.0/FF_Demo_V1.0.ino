...
void setup(){
  ...
  delay(2000);
  //moveRobot(216, 540, 594, 512, 889, 1000);
}
...
void moveRobot(int base, int sholder, int elbow, int wrist, int finger, int timeDelay){
  Herkulex.moveAll(0x00, base, LED_BLUE);  
  Herkulex.moveAll(1, sholder, LED_BLUE); 
  Herkulex.moveAll(2, elbow, LED_BLUE); 
  Herkulex.moveAll(3, wrist, LED_BLUE); 
  Herkulex.moveAll(4, finger, LED_BLUE); 
  Herkulex.actionAll(timeDelay);
}
