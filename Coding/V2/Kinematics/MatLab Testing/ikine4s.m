function [theta0, theta1, theta2, theta3] = ikine4s( x, y, z) %implementing a trigonometric appraoch, thinking much about transfromation matrices and so on....
l0 = 6;
l1 = 6.7;
l2 = 5.7;
l3 = 3.4;
